...
## Chart
```{raw} html
<iframe src="../../_static/MarginCall999--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html" height="500px" width="100%"></iframe>

<p style="text-align: center;">Sources: </p>
```
[Full Screen Chart](../download_chart/MarginCall999--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html)
...
| Seasonal Adjustment    |                                     |
| Units                  | Probability (%)                                                  |
| HTML Chart             | [HTML](../download_chart/MarginCall999--finm32900_hw4_fedwatch/fedwatch_latest_forecast.html)    |
...
|--------------------------------|--------------------------------------------------------------------------------------|
| Dataframe ID                   | [fed_funds_futures](../dataframes/MarginCall999--finm32900_hw4_fedwatch/fed_funds_futures.md)                                       |
| Sources                        |                                           |
| Providers                      |                                         |
| Provider Links                 |                                    |
...
- [MarginCall999/finm32900_hw4_fedwatch:fedwatch_latest_forecast](../../charts/MarginCall999--finm32900_hw4_fedwatch.fedwatch_latest_forecast.md)
...
|---------------------------------|--------------------------------------------------------|
| Pipeline ID                     | [MarginCall999/finm32900_hw4_fedwatch](../../index.md)              |
...
| Date of Last Code Update        | 2026-09-05 11:55:55           |
| OS Compatibility                | Windows, Linux, macOS |
| Linked Dataframes               |  [MarginCall999/finm32900_hw4_fedwatch:fed_funds_futures](../dataframes/MarginCall999--finm32900_hw4_fedwatch/fed_funds_futures.md)<br>  |
